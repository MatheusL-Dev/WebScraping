...
class webScraping():
    ...
    def request(self, browser, url):
        """ Faz as requisicoes atraves do browser criado """
    ...
    def get_anunciante(self, browser, anuncios):
        """ Busca as informacoes dos anunciantes """ 
    ...
    def save_file(self, data):
        """ Cria e salva das informacoes em um arquivo CSV """
